...
//     console.log(
//       `${name} booked a seatt on ${this.airline} flight ${this.iataCode}${flightNumber}`
//     ),
//       this.booking.push({ flight: `${this.iataCode}${flightNumber}`, name });
//   },
// };

// lufthansa.book(657, 'matin bahadoran');
...
// book.call(Eurowing, 263, 'ey koskhol ba lebase ziba');
...
// // const addVat = add.addTex.bind(null, 0.23);
